...
namespace ConsoleAppProject.App02
{
    ...
    /// After the values are entered, the user's BMI will be closed and displayed,
    /// indicating their weight status according to the W.H.O. guideline.
    /// </summary>
    /// <author>
    /// Nicole ffff version 0.1
    /// </author>
